...
class test_ospf(unittest.TestCase):
    ...
    def test_complete_output(self):
        ...
        ospf.maker.outputs[ShowIpOspfMplsLdpInterface] = {"{'vrf':'all'}":OspfOutput.ShowIpOspfMplsLdpInterfaceVrfAll}
        ...
        ospf.maker.outputs[ShowIpOspfInterface] = {"{'vrf':'all'}":OspfOutput.ShowIpOspfInterfaceVrfAll}
        ospf.maker.outputs[ShowIpOspfNeighborDetail] = {"{'vrf':'all'}":OspfOutput.ShowIpOspfNeighborDetailVrfAll}
    ...
    def test_empty_output(self):
        ...
        ospf.maker.outputs[ShowIpOspfMplsLdpInterface] = {"{'vrf':'all'}":{}}
        ospf.maker.outputs[ShowIpOspfVirtualLinks] = {"{'vrf':'all'}":{}}
        ospf.maker.outputs[ShowIpOspfShamLinks] = {"{'vrf':'all'}":{}}
        ospf.maker.outputs[ShowIpOspfInterface] = {"{'vrf':'all'}":{}}
        ospf.maker.outputs[ShowIpOspfNeighborDetail] = {"{'vrf':'all'}":{}}
