...
class Lisp(Base):
    ...
    def learn(self):
        ...
        # lisp_router_instance_id
        self.add_leaf(cmd=ShowLispService,
        ...
        for service in ['ipv4', 'ipv6', 'ethernet']:
            ...
            self.add_leaf(cmd=ShowLispServiceSummary,
            ...
            if hasattr(self, 'info') and service in self.info and \
                ...
                for instance_id in sorted(self.info[service]['instance_ids']):
                    ...
                    #   locator_set_name
                    #       locator_set_name
                    self.add_leaf(cmd=ShowLispServiceDatabase,
                    ...
                    #               auth_key_value - N/A
                    #               auth_key_type - N/A
                    self.add_leaf(cmd=ShowLispServiceServerDetailInternal,
                    ...
                    for key in ['vni', 'extranets']:
                        self.add_leaf(cmd=ShowLispExtranet,
                    ...
                    for key in ['map_register_records_in',
                        ...
                        if key == 'map_server_proxy_reply_records_out':
                          ...
                          key2 = 'map_registers_in'
                            ...
                            key2 = key
                        # add the leaf
                        self.add_leaf(cmd=ShowLispServiceStatistics,
                    ...
                    for key in ['number_configured_sites', 
                        ...
                        self.add_leaf(cmd=ShowLispServiceServerSummary,
                    ...
                    #       instance_id
                    #           vni
                    self.add_leaf(cmd=ShowLispServiceMapCache,
