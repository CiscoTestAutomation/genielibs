...
# Genie
from genie.libs.ops.terminal.nxos.terminal import Terminal
from genie.libs.ops.terminal.nxos.tests.terminal_output import TerminalOutput

# Parser
from genie.libs.parser.nxos.show_terminal import ShowTerminal
