...
class Hsrp(SuperHsrp):
    ...
    def learn(self):
        ...
        # tracked_object
        # tracked_object_priority_decrement N/A
        for key in ['object_name', 'priority_decrement']:
            self.add_leaf(cmd=ShowStandbyAll,
        ...
        # global_ipv6_address
        self.add_leaf(cmd=ShowStandbyAll,
                      src=hsrp_src+'[global_ipv6_addresses]'
                          '[(?P<global_ipv6_addresses>.*)][address]'
                          '[(?P<address>.*)]',
                      dest=hsrp_dest+'[global_ipv6_addresses]'
                           '[(?P<global_ipv6_addresses>.*)][address]'
                           '[(?P<address>.*)]')
        ...
        self.add_leaf(cmd=ShowStandbyAll,
                      ...
                      '[(?P<global_ipv6_address>.*)][address][(?P<address>.*)]',
        ...
        for key in ['minimum_delay', 'reload_delay']:
            self.add_leaf(cmd=ShowStandbyDelay,
