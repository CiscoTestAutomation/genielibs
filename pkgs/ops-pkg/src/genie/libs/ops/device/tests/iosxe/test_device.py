...
# genie.libs
from genie.libs.ops.device.iosxe.device import Device as DeviceModel
from genie.libs.ops.device.tests.iosxe.device_output import DeviceOutput
...
from genie.libs.parser.iosxe.show_platform import (ShowBootvar,
                                                   ShowEnvAll,
                                                   ShowVersion)

outputs = {
    'show bootvar': DeviceOutput.ShowBootvar,
