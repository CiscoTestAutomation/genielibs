...
class AclOutput(object):
    ...
    ShowAccessLists = {
        'acl_name': {'aces': {'10': {'actions': {'forwarding': 'permit',
                                               'logging': 'log-none'},
                                      'matches': {'l3': {'ipv4': {'destination_network': {'any': {'destination_network': 'any'}},
                                                                  'protocol': 'ipv4',
         ...
         'test1': {'aces': {'10': {'actions': {'forwarding': 'permit',
                                               'logging': 'log-syslog'},
                                   'matches': {'l3': {'pim': {'destination_network': {'any': {'destination_network': 'any'}},
                                                              'dscp': 'default',
                                                              'protocol': 'pim',
                                                              'source_network': {'any': {'source_network': 'any'}}}},
                            ...
                            '20': {'actions': {'forwarding': 'permit',
                                               'logging': 'log-none'},
                                   'matches': {'l3': {'icmp': {'source_network': {'0.1.1.1 255.0.0.0': {'source_network': '0.1.1.1 '
                                                                                                                                              '255.0.0.0'}},
                                                               'protocol': 'icmp',
         ...
         'test22': {'aces': {'10': {'actions': {'forwarding': 'permit',
          ...
          'ipv6_acl': {'aces': {'20': {'actions': {'forwarding': 'permit',
                                                  'logging': 'log-none'},
                                      'matches': {'l3': {'ipv6': {'destination_network': {'2001:1::2': {'destination_network': '2001:1::2'}},
                                                                  'protocol': 'ipv6',
                                                                  'source_network': {'2001::1': {'source_network': '2001::1'}}}},
                                                  'l4': {'ipv6': {'established': False}}},
                                      'name': '20'},
                               '30': {'actions': {'forwarding': 'permit',
                                                  'logging': 'log-none'},
                                      'matches': {'l3': {'tcp': {'destination_network': {'2001:2::2': {'destination_network': '2001:2::2'}},
                                                                 'protocol': 'tcp',
                                                                 'source_network': {'any': {'source_network': 'any'}}}},
                                                  'l4': {'tcp': {'established': False,
                                                                 'source_port': {'operator': {'operator': 'eq',
         ...
         'preauth_v6': {'aces': {'10': {'actions': {'forwarding': 'permit',
                                                    'logging': 'log-none'},
                                        'matches': {'l3': {'udp': {'destination_network': {'any': {'destination_network': 'any'}},
                                                                   'protocol': 'udp',
                                                                   'source_network': {'any': {'source_network': 'any'}}}},
                                 ...
                                 '20': {'actions': {'forwarding': 'permit',
                                                    'logging': 'log-syslog'},
                                        'matches': {'l3': {'esp': {'destination_network': {'any': {'destination_network': 'any'}},
                                                                   'dscp': 'cs7',
                                                                   'protocol': 'esp',
                                                                   'source_network': {'any': {'source_network': 'any'}}}},
                                 ...
                                 '30': {'actions': {'forwarding': 'deny',
                                                    'logging': 'log-none'},
                                        'matches': {'l3': {'ipv6': {'destination_network': {'any': {'destination_network': 'any'}},
                                                                    'protocol': 'ipv6',
                                                                    'source_network': {'any': {'source_network': 'any'}}}},
                                                    'l4': {'ipv6': {'established': False}}},
                                        'name': '30'}},
    ...
    Acl_info = {
        'acls': {'acl_name': {'aces': {'10': {'actions': {'forwarding': 'permit',
                                                         'logging': 'log-none'},
                ...
                'ipv4_acl': {'aces': {'10': {'actions': {'forwarding': 'permit',
                                                         'logging': 'log-none'},
                                             'matches': {'l4': {'tcp': {'destination_port': {'operator': {'operator': 'eq',
                                                                                                          'port': 80}},
                                                                        'established': False}}},
                                             'name': '10'},
                                      '20': {'actions': {'forwarding': 'permit',
                ...
                'ipv6_acl': {'aces': {'20': {'actions': {'forwarding': 'permit',
                                                         'logging': 'log-none'},
                                             'matches': {'l3': {'ipv6': {'destination_ipv6_network': {'2001:1::2': {'destination_ipv6_network': '2001:1::2'}},
                                                                         'protocol': 'ipv6',
                                                                         'source_ipv6_network': {'2001::1': {'source_ipv6_network': '2001::1'}}}}},
                                             'name': '20'},
                                      '30': {'actions': {'forwarding': 'permit',
                                                         'logging': 'log-none'},
                                             'matches': {'l4': {'tcp': {'established': False,
                                                                        'source_port': {'operator': {'operator': 'eq',
                                                                                                     'port': 'www '
                                                                                                             '8443'}}}}},
                                             'name': '30'},
                ...
                'preauth_v6': {'aces': {'10': {'actions': {'forwarding': 'permit',
                                                           'logging': 'log-none'},
                                               'matches': {'l4': {'udp': {'destination_port': {'operator': {'operator': 'eq',
                                                                                                            'port': 53}}}}},
                                               'name': '10'},
                                        '20': {'actions': {'forwarding': 'permit',
                                                           'logging': 'log-syslog'},
                                        ...
                                        '30': {'actions': {'forwarding': 'deny',
                                                           'logging': 'log-none'},
                                               'matches': {'l3': {'ipv6': {'destination_ipv6_network': {'any': {'destination_ipv6_network': 'any'}},
                                                                           'protocol': 'ipv6',
                                                                           'source_ipv6_network': {'any': {'source_ipv6_network': 'any'}}}}},
                                               'name': '30'}},
                               'name': 'preauth_v6',
                               'type': 'ipv6-acl-type'},
                'test1': {'aces': {'10': {'actions': {'forwarding': 'permit',
                ...
                'test22': {'aces': {'10': {'actions': {'forwarding': 'permit',
                                                       'logging': 'log-syslog'},
                                           'matches': {'l4': {'tcp': {'established': True}}},
                                           'name': '10'},
                                    '20': {'actions': {'forwarding': 'permit',
                                                       'logging': 'log-none'},
                                           'matches': {'l4': {'tcp': {'established': False,
