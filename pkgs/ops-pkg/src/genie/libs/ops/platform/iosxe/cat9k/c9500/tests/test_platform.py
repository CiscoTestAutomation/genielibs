...
# Genie Xbu_shared
from genie.libs.ops.platform.iosxe.cat9k.c9500.platform import Platform
from genie.libs.ops.platform.iosxe.cat9k.c9500.tests.platform_output import PlatformOutput
