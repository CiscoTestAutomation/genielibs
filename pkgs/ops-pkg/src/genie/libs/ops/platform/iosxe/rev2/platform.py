...
class Platform(SuperPlatform):
    ...
    def learn(self):
        ...
        # swstack
        self.add_leaf(cmd=show_inventory_command, revision='2',
                      src='[main][swstack]',
                      dest='swstack')
        ...
        # rp_name
        self.add_leaf(cmd=show_platform_command, revision='1',
        ...
        self.add_leaf(cmd=show_inventory_command, revision='2',
                      ...
                      dest='[slot][oc][(?P<slot>.*)][subslot][(?P<subslot>.*)][pid]')
        ...
        # Pluggables from show inventory
        # oc_dc_name
        self.add_leaf(cmd=show_inventory_command, revision='2',
                      src='[slot][(?P<slot>.*)][pluggable][(?P<ifname>.*)][name]',
                      dest='[slot][oc][(?P<ifname>.*)][name]')

        # oc_dc_pid
        self.add_leaf(cmd=show_inventory_command, revision='2',
                      src='[slot][(?P<slot>.*)][pluggable][(?P<ifname>.*)][pid]',
                      dest='[slot][oc][(?P<ifname>.*)][pid]')

        # oc_dc_sn
        self.add_leaf(cmd=show_inventory_command, revision='2',
                      src='[slot][(?P<slot>.*)][pluggable][(?P<ifname>.*)][sn]',
                      dest='[slot][oc][(?P<ifname>.*)][sn]')
