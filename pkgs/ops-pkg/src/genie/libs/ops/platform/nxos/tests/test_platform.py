...
class test_platform_all(unittest.TestCase):
    ...
    def test_sample(self):
        ...
        self.assertEqual(f.image, 'slot0:///n7000-s2-dk9.8.1.0.129.gbin')
        self.assertEqual(f.installed_packages, 'n7700-s2-dk9.7.2.0.D1.1.CSCuo7721.bin')
        self.assertEqual(f.kickstart_image, 'slot0:///n7000-s2-kickstart.8.1.0.129.gbin')
