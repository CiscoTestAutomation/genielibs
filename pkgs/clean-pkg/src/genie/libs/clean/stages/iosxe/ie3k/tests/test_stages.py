...
from genie.libs.clean.stages.iosxe.ie3k.stages import RommonBoot
...
class TestRommonBoot(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.device = create_test_device(
            name='aDevice', os='iosxe', platform='ie3k')
    ...
    @mock.patch('genie.libs.clean.stages.iosxe.ie3k.stages.Statement')
    @mock.patch('genie.libs.clean.stages.iosxe.ie3k.stages.Dialog')
    ...
    @mock.patch('genie.libs.clean.stages.iosxe.ie3k.stages.pcall')
    ...
    @mock.patch('genie.libs.clean.stages.iosxe.ie3k.stages.Lookup')
    ...
    @mock.patch('genie.libs.clean.stages.iosxe.ie3k.stages._disconnect_reconnect')
