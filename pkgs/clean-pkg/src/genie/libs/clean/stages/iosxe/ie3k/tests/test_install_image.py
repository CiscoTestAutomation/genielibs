...
from genie.libs.clean.stages.iosxe.ie3k.stages import InstallImage
...
class Installimage(unittest.TestCase):
    ...
    def test_pass(self):
        ...
        self.cls.new_boot_var = 'flash:/ie31xx-universalk9.BLD_POLARIS_DEV_LATEST_20241204_191609.SSA.bin'
