...
class TestConfigureCallHomeProfileSubscribeToAlertGroup(unittest.TestCase):
    ...
    def test_configure_call_home_profile_subscribe_to_alert_group(self):
        result = configure_call_home_profile_subscribe_to_alert_group(self.device, 'test', 'crash')
