...
from genie.libs.sdk.apis.iosxe.prp.configure import unconfigure_prp_sup_vlan_aware_allowed_vlan_list
...
class TestUnconfigurePrpSupVlanAwareAllowedVlanList(unittest.TestCase):
    ...
    def test_unconfigure_prp_sup_vlan_aware_allowed_vlan_list(self):
        result = unconfigure_prp_sup_vlan_aware_allowed_vlan_list(self.device, 1)
