...
class TestConfigureCallHomeProfileDestinationMessageSizeLimit(unittest.TestCase):
    ...
    def test_configure_call_home_profile_destination_message_size_limit(self):
        result = configure_call_home_profile_destination_message_size_limit(self.device, 'test', '1000')
