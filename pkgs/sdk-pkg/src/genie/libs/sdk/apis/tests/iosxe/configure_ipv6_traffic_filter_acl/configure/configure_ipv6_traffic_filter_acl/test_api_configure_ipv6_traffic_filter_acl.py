...
class TestConfigureIpv6TrafficFilterAcl(TestCase):

    def test_configure_ipv6_traffic_filter_acl(self):
        device = Mock()
        result = configure_ipv6_traffic_filter_acl(device, 11, 20, 'ipv6_md_acl', 'in')
        ...
        self.assertEqual(
            ...
            (['interface range vlan 11-20', 'ipv6 traffic-filter ipv6_md_acl in'],)
        )
