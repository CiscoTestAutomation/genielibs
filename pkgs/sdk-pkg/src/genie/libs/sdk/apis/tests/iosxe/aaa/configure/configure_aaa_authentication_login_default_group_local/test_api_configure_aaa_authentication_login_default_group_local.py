...
class TestConfigureAaaAuthenticationLoginDefaultGroupLocal(unittest.TestCase):
    ...
    def test_configure_aaa_authentication_login_default_group_local(self):
        result = configure_aaa_authentication_login_default_group_local(self.device, 'TACACS-group')
