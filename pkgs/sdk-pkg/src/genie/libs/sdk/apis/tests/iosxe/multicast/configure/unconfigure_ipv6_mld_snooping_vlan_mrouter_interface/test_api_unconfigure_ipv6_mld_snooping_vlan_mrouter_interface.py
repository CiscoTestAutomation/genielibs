...
class TestUnconfigureIpv6MldSnoopingVlanMrouterInterface(unittest.TestCase):
    ...
    def test_unconfigure_ipv6_mld_snooping_vlan_mrouter_interface(self):
        result = unconfigure_ipv6_mld_snooping_vlan_mrouter_interface(self.device, '1', 'g0/0')
