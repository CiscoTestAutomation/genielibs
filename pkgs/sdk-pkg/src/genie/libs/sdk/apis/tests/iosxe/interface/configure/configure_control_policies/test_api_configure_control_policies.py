...
class TestConfigureControlPolicies(unittest.TestCase):
    ...
    def test_configure_control_policies(self):
        result = configure_control_policies(self.device, 'PMAP_DefaultWiredDot1xClosedAuth_1X_MAB', 'aaa-available', 'match-all', 10, None, 'do-until-failure', 10, 'resume', 'reauthentication', None, None, 10, None, 3, None)
