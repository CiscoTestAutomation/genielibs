...
class TestConfigureInterfaceEvpnEthernetSegment(TestCase):

    def test_configure_interface_evpn_ethernet_segment(self):
        device = Mock()
        device.state_machine.current_state = 'enable'

        result = configure_interface_evpn_ethernet_segment(device, 'Gi1/0/18', 10)
        ...
        self.assertIn('interface Gi1/0/18', cfg_lines)
        self.assertIn('evpn ethernet-segment 10', cfg_lines)
