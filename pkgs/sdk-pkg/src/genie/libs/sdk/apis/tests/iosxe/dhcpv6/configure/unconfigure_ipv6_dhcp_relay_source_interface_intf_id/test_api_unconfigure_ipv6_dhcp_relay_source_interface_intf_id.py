...
class TestUnconfigureIpv6DhcpRelaySourceInterfaceIntfId(unittest.TestCase):
    ...
    def test_unconfigure_ipv6_dhcp_relay_source_interface_intf_id(self):
        result = unconfigure_ipv6_dhcp_relay_source_interface_intf_id(self.device, 'Vlan1500', 'Loopback1')
