...
class TestUnconfigureInterfacePvlanModeWithSubmode(unittest.TestCase):
    ...
    def test_unconfigure_interface_pvlan_mode_with_submode(self):
        result = unconfigure_interface_pvlan_mode_with_submode(self.device, 'TwentyFiveGigE1/0/31')
