...
class TestConfigureInterfaceIpDhcpRelaySourceInterfaceIntfId(unittest.TestCase):
    ...
    def test_configure_interface_ip_dhcp_relay_source_interface_intf_id(self):
        result = configure_interface_ip_dhcp_relay_source_interface_intf_id(self.device, 'vlan100', 'Loopback1')
