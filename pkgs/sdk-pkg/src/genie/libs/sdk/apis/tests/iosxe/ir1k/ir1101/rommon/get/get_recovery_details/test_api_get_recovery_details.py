...
from genie.libs.sdk.apis.iosxe.ir1k.ir1101.rommon.get import get_recovery_details
...
"""
    ...
    def test_get_recovery_details_tftp_ignored(self):
        """Verify tftp_boot parameter is ignored (IR1101 does not support TFTP boot in ROMMON)."""
        tftp_boot = {
        ...
        # TFTP info should NOT appear in result for IR1101
        expected = {
            'golden_image': ['usbflash0:ir1101-universalk9.BLD_V1712_THROTTLE_LATEST_20250115_100327_V17_12_0_141.bin']
        }
