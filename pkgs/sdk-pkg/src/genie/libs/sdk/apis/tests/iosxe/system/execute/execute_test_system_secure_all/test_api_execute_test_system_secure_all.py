...
from genie.libs.sdk.apis.iosxe.system.execute import execute_test_system_secure_all
from unittest.mock import Mock


class TestExecuteTestSystemSecureAll(TestCase):

    def test_execute_test_system_secure_all(self):
        self.device = Mock()
        results_map = {
...
display_insecure_config_summary: Active insecure configuration database walk completed""",
        ...
        result = execute_test_system_secure_all(self.device)
        self.assertIn(
            'test system secure all',
