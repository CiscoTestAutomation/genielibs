...
class TestConfigureInterfaceSnmpTrapMacNotificationChange(unittest.TestCase):
    ...
    def test_configure_interface_snmp_trap_mac_notification_change(self):
        result = configure_interface_snmp_trap_mac_notification_change(self.device, 'te1/0/7', 'added')
