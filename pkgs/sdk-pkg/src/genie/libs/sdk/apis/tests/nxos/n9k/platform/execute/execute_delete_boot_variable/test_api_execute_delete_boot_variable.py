...
from genie.libs.sdk.apis.nxos.n9k.platform.execute import execute_delete_boot_variable
...
class TestExecuteDeleteBootVariable(unittest.TestCase):
    ...
    def test_execute_delete_boot_variable(self):
        ...
        device.configure.assert_called_once_with('no boot nxos', timeout=300)

        device.api.execute_copy_run_to_start.assert_called_once_with(
            copy_vdc_all=True, command_timeout=300
        )
