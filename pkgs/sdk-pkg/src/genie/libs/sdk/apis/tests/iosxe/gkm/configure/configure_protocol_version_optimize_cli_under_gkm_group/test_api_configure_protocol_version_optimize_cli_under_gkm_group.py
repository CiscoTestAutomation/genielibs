...
class TestConfigureProtocolVersionOptimizeCliUnderGkmGroup(unittest.TestCase):
    ...
    def test_configure_protocol_version_optimize_cli_under_gkm_group(self):
        result = configure_protocol_version_optimize_cli_under_gkm_group(self.device, 'v4-cust-gdoi1000', True, True, True)
