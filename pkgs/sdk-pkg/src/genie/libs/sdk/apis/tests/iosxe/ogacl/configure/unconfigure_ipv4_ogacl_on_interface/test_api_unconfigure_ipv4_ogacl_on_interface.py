...
class TestUnconfigureIpv4OgaclOnInterface(unittest.TestCase):
    ...
    def test_unconfigure_ipv4_ogacl_on_interface(self):
        result = unconfigure_ipv4_ogacl_on_interface(self.device, 'TenGigabitEthernet7/0/4', 'ogacl_policy_in', True)
