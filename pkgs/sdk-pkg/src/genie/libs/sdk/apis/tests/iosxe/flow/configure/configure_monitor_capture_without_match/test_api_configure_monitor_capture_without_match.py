...
class TestConfigureMonitorCaptureWithoutMatch(unittest.TestCase):
    ...
    def test_configure_monitor_capture_without_match(self):
        result = configure_monitor_capture_without_match(self.device, 'REL', 'both', 'TwentyFiveGigE1/0/5')
