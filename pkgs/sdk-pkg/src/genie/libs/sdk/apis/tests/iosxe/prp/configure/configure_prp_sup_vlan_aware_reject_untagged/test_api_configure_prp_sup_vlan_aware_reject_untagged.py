...
from genie.libs.sdk.apis.iosxe.prp.configure import configure_prp_sup_vlan_aware_reject_untagged
...
class TestConfigurePrpSupVlanAwareRejectUntagged(unittest.TestCase):
    ...
    def test_configure_prp_sup_vlan_aware_reject_untagged(self):
        result = configure_prp_sup_vlan_aware_reject_untagged(self.device, 1)
