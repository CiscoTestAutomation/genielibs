...
class TestConfigureCallHomeProfileAnonymousReportingOnly(unittest.TestCase):
    ...
    def test_configure_call_home_profile_anonymous_reporting_only(self):
        result = configure_call_home_profile_anonymous_reporting_only(self.device, 'test')
