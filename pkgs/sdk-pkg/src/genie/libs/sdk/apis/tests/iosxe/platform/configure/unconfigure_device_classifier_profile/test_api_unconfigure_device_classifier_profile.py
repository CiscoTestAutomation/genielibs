...
class TestUnconfigureDeviceClassifierProfile(unittest.TestCase):
    ...
    def test_unconfigure_device_classifier_profile(self):
        result = unconfigure_device_classifier_profile(self.device, 'condition', 'COND_TEST_A', 'no lldp', 'tlv-type 6 value String Cisco', 'no device classifier', 'condition', 'CDP_RULE_TLV_1')
