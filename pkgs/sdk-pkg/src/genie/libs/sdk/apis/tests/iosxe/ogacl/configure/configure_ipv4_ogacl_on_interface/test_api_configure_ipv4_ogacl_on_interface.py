...
class TestConfigureIpv4OgaclOnInterface(unittest.TestCase):
    ...
    def test_configure_ipv4_ogacl_on_interface(self):
        result = configure_ipv4_ogacl_on_interface(self.device, 'TenGigabitEthernet7/0/4', 'ogacl_policy_in', True)
