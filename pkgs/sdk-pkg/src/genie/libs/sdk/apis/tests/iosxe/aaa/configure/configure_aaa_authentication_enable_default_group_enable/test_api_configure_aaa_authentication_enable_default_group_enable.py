...
class TestConfigureAaaAuthenticationEnableDefaultGroupEnable(unittest.TestCase):
    ...
    def test_configure_aaa_authentication_enable_default_group_enable(self):
        result = configure_aaa_authentication_enable_default_group_enable(self.device, 'TACACS-group')
