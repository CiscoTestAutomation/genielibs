...
class TestConfigureSnmpServerTrap(unittest.TestCase):
    ...
    def test_configure_snmp_server_trap(self):
        result = configure_snmp_server_trap(self.device, 'GigabitEthernet1', '30.30.30.2', 'traps', '3', 'privuser256256', 'config', None)
        expected_output = None
        self.assertEqual(result, expected_output)

    def test_configure_snmp_server_trap_1(self):
        result = configure_snmp_server_trap(self.device, 'GigabitEthernet1', '30.30.30.2', 'informs', '3', 'privuser256256', 'config', '800000090300005056BE0829')
        expected_output = None
        self.assertEqual(result, expected_output)
