...
class TestUnconfigureDhcpSnoopingVerifyNoRelayAgentAddress(unittest.TestCase):
    ...
    def test_unconfigure_dhcp_snooping_verify_no_relay_agent_address(self):
        result = unconfigure_dhcp_snooping_verify_no_relay_agent_address(self.device)
