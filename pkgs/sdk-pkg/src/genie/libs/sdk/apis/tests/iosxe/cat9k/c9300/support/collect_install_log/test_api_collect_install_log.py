...
from genie.libs.sdk.apis.iosxe.cat9k.c9300.support.tech_support import collect_install_log

class TestCollectInstallLog(unittest.TestCase):

    @patch('genie.libs.sdk.apis.iosxe.cat9k.c9300.support.tech_support.log')
    @patch('genie.libs.sdk.apis.iosxe.cat9k.c9300.support.tech_support.get_default_dir')
    @patch('genie.libs.sdk.apis.iosxe.cat9k.c9300.support.tech_support.datetime')
    def test_collect_install_log_success(self, mock_datetime, mock_get_default_dir, mock_log):
        ...
        with patch.object(type(runtime), 'directory', new_callable=PropertyMock) as mock_dir:
            ...
            device.execute.side_effect = [
                None, # show platform software install-manager switch active R0 operation current detail
                None, # show platform software install-manager switch active R0 operation history detail
