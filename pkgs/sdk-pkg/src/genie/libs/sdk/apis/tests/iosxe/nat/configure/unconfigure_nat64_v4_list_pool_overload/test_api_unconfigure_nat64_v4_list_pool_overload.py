...
class TestUnconfigureNat64V4ListPoolOverload(unittest.TestCase):
    ...
    def test_unconfigure_nat64_v4_list_pool_overload(self):
        result = unconfigure_nat64_v4_list_pool_overload(self.device, 'acl_1', 'pool_1', 'vrf1', 'match-in-vrf')
