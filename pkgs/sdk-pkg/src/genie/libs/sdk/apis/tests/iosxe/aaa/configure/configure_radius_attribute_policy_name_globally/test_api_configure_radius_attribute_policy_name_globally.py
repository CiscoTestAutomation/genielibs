...
class TestConfigureRadiusAttributePolicyNameGlobally(unittest.TestCase):
    ...
    def test_configure_radius_attribute_policy_name_globally(self):
        result = configure_radius_attribute_policy_name_globally(self.device, 'e8eb.340a.c100:ABCD', 'access')
