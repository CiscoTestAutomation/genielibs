...
class TestConfigureRadiusAttributePolicyNameUnderServer(unittest.TestCase):
    ...
    def test_configure_radius_attribute_policy_name_under_server(self):
        result = configure_radius_attribute_policy_name_under_server(self.device, 'ISE', 'e8eb.340a.c100:ABCD', 'accounting')
