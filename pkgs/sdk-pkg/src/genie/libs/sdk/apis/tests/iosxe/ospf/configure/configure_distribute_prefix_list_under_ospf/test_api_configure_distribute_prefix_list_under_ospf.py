...
class TestConfigureDistributePrefixListUnderOspf(unittest.TestCase):
    ...
    def test_configure_distribute_prefix_list_under_ospf(self):
        result = configure_distribute_prefix_list_under_ospf(self.device, 1, 'ospf_prefix_list', 'out', None)
