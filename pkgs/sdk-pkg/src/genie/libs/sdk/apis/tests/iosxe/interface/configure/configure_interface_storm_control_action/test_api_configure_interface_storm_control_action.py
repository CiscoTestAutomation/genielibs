...
class TestConfigureInterfaceStormControlAction(unittest.TestCase):
    ...
    def test_configure_interface_storm_control_action(self):
        result = configure_interface_storm_control_action(self.device, 'GigabitEthernet1/0/2', 'shutdown')
        expected_output = None
        self.assertEqual(result, expected_output)

    def test_configure_interface_storm_control_action_1(self):
        result = configure_interface_storm_control_action(self.device, 'GigabitEthernet1/0/2', 'trap')
        expected_output = None
        self.assertEqual(result, expected_output)
