...
class TestUnconfigureAccessMapMatchIpAddressActionForward(unittest.TestCase):
    ...
    def test_unconfigure_access_map_match_ip_address_action_forward(self):
        result = unconfigure_access_map_match_ip_address_action_forward(self.device, 'vacl1')
