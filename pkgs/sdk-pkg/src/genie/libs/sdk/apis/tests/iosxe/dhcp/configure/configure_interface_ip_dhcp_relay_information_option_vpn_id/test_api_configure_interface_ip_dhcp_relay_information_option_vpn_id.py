...
class TestConfigureInterfaceIpDhcpRelayInformationOptionVpnId(unittest.TestCase):
    ...
    def test_configure_interface_ip_dhcp_relay_information_option_vpn_id(self):
        result = configure_interface_ip_dhcp_relay_information_option_vpn_id(self.device, 'vlan100')
