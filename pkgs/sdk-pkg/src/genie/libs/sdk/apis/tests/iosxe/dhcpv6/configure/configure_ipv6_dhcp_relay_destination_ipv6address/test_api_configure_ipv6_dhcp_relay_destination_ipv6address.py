...
class TestConfigureIpv6DhcpRelayDestinationIpv6address(unittest.TestCase):
    ...
    def test_configure_ipv6_dhcp_relay_destination_ipv6address(self):
        result = configure_ipv6_dhcp_relay_destination_ipv6address(self.device, 'Vlan1500', '2000::1')
