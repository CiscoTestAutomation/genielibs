...
class TestUnconfigureIcmpIpReachables(unittest.TestCase):
    ...
    def test_unconfigure_icmp_ip_reachables(self):
        result = unconfigure_icmp_ip_reachables(self.device, 'Te1/0/10', 'connected to interface', '50.1.1.2', '255.255.0.0')
