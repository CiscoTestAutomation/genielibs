...
class TestConfigureHwSwitchSwitchLoggingOnboardEnvironment(unittest.TestCase):
    ...
    def test_configure_hw_switch_switch_logging_onboard_environment(self):
        result = configure_hw_switch_switch_logging_onboard_environment(self.device, '1')
