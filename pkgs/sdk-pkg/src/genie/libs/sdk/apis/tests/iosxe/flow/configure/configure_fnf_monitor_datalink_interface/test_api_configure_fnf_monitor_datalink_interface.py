...
class TestConfigureFnfMonitorDatalinkInterface(unittest.TestCase):
    ...
    def test_configure_fnf_monitor_datalink_interface(self):
        result = configure_fnf_monitor_datalink_interface(self.device, 'GigabitEthernet1/0/1', 'fl_mon_Po', 's4', 'input')
