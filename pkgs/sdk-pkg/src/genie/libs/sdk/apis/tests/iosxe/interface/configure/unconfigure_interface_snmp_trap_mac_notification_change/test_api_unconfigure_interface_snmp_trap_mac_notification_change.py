...
class TestUnconfigureInterfaceSnmpTrapMacNotificationChange(unittest.TestCase):
    ...
    def test_unconfigure_interface_snmp_trap_mac_notification_change(self):
        result = unconfigure_interface_snmp_trap_mac_notification_change(self.device, 'te1/0/7', 'added')
