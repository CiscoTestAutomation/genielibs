...
class TestConfigureInterfaceSwitchport(TestCase):
    ...
    def test_configure_interface_switchport(self):
        ...
        result = configure_interface_switchport(
            device,
            "FortyGigabitEthernet2/1/0/16",
        )
        ...
        self.assertIn(
            "interface FortyGigabitEthernet2/1/0/16",
            sent_commands,
        )
