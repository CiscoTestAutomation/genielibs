...
class TestConfigureEvpnL3InstanceVlanAssociation(TestCase):

    def test_configure_evpn_l3_instance_vlan_association(self):
        device = Mock()
        device.state_machine.current_state = 'enable'

        result = configure_evpn_l3_instance_vlan_association(device, '20', '60020')
        ...
        self.assertIn('vlan configuration 20', cfg_lines)
        self.assertIn('member vni 60020', cfg_lines)
