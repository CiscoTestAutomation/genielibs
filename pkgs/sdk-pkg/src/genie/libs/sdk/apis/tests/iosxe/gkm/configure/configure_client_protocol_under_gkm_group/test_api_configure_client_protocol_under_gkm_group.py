...
class TestConfigureClientProtocolUnderGkmGroup(unittest.TestCase):
    ...
    def test_configure_client_protocol_under_gkm_group(self):
        result = configure_client_protocol_under_gkm_group(self.device, 'v4-cust-gdoi1001', 'gikev2', 'gikev2-profile')
