...
class TestUnconfigurePortChannelIp(unittest.TestCase):
    ...
    def test_unconfigure_port_channel_ip(self):
        result = unconfigure_port_channel_ip(self.device, 5, 'ip', True)
        expected_output = None
        self.assertEqual(result, expected_output)

    def test_unconfigure_port_channel_ip_1(self):
        result = unconfigure_port_channel_ip(self.device, 5, 'ip', False)
        expected_output = None
        self.assertEqual(result, expected_output)
