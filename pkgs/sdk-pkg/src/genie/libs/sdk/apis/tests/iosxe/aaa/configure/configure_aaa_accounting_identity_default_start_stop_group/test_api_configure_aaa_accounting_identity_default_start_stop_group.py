...
class TestConfigureAaaAccountingIdentityDefaultStartStopGroup(unittest.TestCase):
    ...
    def test_configure_aaa_accounting_identity_default_start_stop_group(self):
        result = configure_aaa_accounting_identity_default_start_stop_group(self.device, 'RADIUS_SERVER')
