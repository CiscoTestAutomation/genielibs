...
class TestConfigureRadiusAttributePolicyNameUnderServergroup(unittest.TestCase):
    ...
    def test_configure_radius_attribute_policy_name_under_servergroup(self):
        result = configure_radius_attribute_policy_name_under_servergroup(self.device, 'ISEGRP', 'e8eb.340a.c100:ABCD', 'access')
