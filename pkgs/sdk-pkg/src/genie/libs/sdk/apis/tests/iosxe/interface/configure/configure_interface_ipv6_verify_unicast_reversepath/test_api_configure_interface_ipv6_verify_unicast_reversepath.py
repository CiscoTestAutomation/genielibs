...
from genie.libs.sdk.apis.iosxe.interface.configure import configure_interface_ipv6_verify_unicast_reversepath


class TestConfigureInterfaceIpv6VerifyUnicastReversepath(unittest.TestCase):
