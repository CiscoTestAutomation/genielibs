...
from genie.libs.sdk.apis.iosxe.evpn.configure import configure_l2vpn_evpn_advertise_sync


class TestConfigureL2vpnEvpnAdvertiseSync(TestCase):

    def test_configure_l2vpn_evpn_advertise_sync(self):
        device = Mock()
        device.state_machine.current_state = 'enable'

        result = configure_l2vpn_evpn_advertise_sync(device)
        ...
        self.assertIn('multicast advertise sync-only', cfg_lines)
