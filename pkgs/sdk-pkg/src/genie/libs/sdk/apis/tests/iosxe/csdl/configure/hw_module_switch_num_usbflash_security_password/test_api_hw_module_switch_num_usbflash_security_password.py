...
class TestHwModuleSwitchNumUsbflashSecurityPassword(unittest.TestCase):
    ...
    def test_hw_module_switch_num_usbflash_security_password(self):
        result = hw_module_switch_num_usbflash_security_password(self.device, '1', 'enable', '123456')
