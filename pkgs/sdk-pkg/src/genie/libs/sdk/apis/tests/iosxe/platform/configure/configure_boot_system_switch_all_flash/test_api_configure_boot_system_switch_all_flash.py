...
from genie.libs.sdk.apis.iosxe.platform.configure import configure_boot_system_switch_all_flash


class TestConfigureBootSystemSwitchAllFlash(unittest.TestCase):
