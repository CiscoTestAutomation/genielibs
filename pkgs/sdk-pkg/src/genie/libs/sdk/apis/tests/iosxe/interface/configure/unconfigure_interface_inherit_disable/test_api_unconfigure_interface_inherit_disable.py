...
class TestUnconfigureInterfaceInheritDisable(unittest.TestCase):
    ...
    def test_unconfigure_interface_inherit_disable(self):
        result = unconfigure_interface_inherit_disable(self.device, 'te1/0/6', 'interface-template-sticky')
