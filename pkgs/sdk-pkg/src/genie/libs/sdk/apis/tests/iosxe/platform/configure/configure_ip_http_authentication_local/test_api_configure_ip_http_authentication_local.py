...
from genie.libs.sdk.apis.iosxe.platform.configure import configure_ip_http_authentication_local
...
class TestConfigureIpHttpAuthenticationLocal(unittest.TestCase):
    ...
    def test_configure_ip_http_authentication_local(self):
        result = configure_ip_http_authentication_local(self.device)
