...
from genie.libs.sdk.apis.iosxe.ptp.configure import configure_ptp_neighbor_propagation_delay_threshold
...
class TestConfigurePtpNeighborPropagationDelayThreshold(unittest.TestCase):
    ...
    def test_configure_ptp_neighbor_propagation_delay_threshold(self):
        result = configure_ptp_neighbor_propagation_delay_threshold(self.device, '10')
