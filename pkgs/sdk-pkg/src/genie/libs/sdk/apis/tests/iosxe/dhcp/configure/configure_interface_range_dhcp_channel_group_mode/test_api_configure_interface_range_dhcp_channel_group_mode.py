...
class TestConfigureInterfaceRangeDhcpChannelGroupMode(unittest.TestCase):
    ...
    def test_configure_interface_range_dhcp_channel_group_mode(self):
        result = configure_interface_range_dhcp_channel_group_mode(self.device, 'Gi1/0/39', '41', '200', 'desirable')
