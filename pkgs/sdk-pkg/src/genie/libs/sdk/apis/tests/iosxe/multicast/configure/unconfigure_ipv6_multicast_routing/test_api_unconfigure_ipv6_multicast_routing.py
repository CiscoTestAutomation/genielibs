...
class TestUnconfigureIpv6MulticastRouting(unittest.TestCase):
    ...
    def test_unconfigure_ipv6_multicast_routing(self):
        result = unconfigure_ipv6_multicast_routing(self.device, None)
        expected_output = None
        self.assertEqual(result, expected_output)

    def test_unconfigure_ipv6_multicast_routing_1(self):
        result = unconfigure_ipv6_multicast_routing(self.device, 'green')
        expected_output = None
        self.assertEqual(result, expected_output)
