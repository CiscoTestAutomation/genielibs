...
class TestUtilsApi(unittest.TestCase):
    ...
    def test_copy_from_device_nxos_aci(self):
        ...
        assert re.search(r'curl --upload-file /tmp/test.txt http://127.0.0.1:\d+/router_test.txt', str(device.execute.call_args))
    ...
    def test_copy_to_device_nxos_aci(self):
        ...
        assert re.search(r'curl http://127.0.0.1:\d+//tmp/test.txt -O', str(device.execute.call_args))