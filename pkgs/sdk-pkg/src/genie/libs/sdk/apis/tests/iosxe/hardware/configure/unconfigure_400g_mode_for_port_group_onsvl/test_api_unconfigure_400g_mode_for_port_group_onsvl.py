...
class TestUnconfigure400gModeForPortGroupOnsvl(TestCase):

    def test_unconfigure_400g_mode_for_port_group_onsvl(self):
        device = Mock()
        device.state_machine.current_state = 'enable'

        result = unconfigure_400g_mode_for_port_group_onsvl(
            device,
            2,
            2,
            '1-2',
        ...
        self.assertIn('no hw-module switch 2 slot 2 port-group range 1-2 mode 400G', cfg_lines)
