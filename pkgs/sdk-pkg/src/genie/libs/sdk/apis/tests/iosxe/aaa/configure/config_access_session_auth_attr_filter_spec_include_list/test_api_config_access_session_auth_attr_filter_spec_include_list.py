...
class TestConfigAccessSessionAuthAttrFilterSpecIncludeList(unittest.TestCase):
    ...
    def test_config_access_session_auth_attr_filter_spec_include_list(self):
        result = config_access_session_auth_attr_filter_spec_include_list(self.device, 'aaa_attr')
