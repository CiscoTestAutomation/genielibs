...
class TestUnconfigureNat64NdRaPrefix(unittest.TestCase):
    ...
    def test_unconfigure_nat64_nd_ra_prefix(self):
        result = unconfigure_nat64_nd_ra_prefix(self.device, '2009::', '64', 'TwentyFiveGigE1/0/23', '1', None, None, None, None)
