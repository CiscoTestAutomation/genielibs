...
class TestConfigureCallHomeProfileDestinationTransportMethod(unittest.TestCase):
    ...
    def test_configure_call_home_profile_destination_transport_method(self):
        result = configure_call_home_profile_destination_transport_method(self.device, 'test', 'email')
