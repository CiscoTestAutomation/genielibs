...
# Genie Libs
from genie.libs.sdk.triggers.template.ha import \
                       TriggerSwitchover as SwitchoverTemplate

from genie.libs.sdk.triggers.template.ha import \
                       TriggerReload as ReloadTemplate
...
class TriggerSwitchover(SwitchoverTemplate):
    ...
    def verify_switchover(self, uut, abstract, steps):
        '''Verify if the switchover taken palce
