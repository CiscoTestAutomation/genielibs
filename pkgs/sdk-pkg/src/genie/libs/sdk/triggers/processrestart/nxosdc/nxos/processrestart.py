'''
Implementation for NXOSDC Restart triggers
'''
...
class TriggerProcessCrashRestartNXOSDC(TriggerProcessRestart):
    """Restart the running NXOS DC process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core."""
    
    __description__ = """Restart the running NXOS DC process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core.
...
class TriggerProcessKillRestartNXOSDC(TriggerProcessRestart):
    """Restart the running NXOS DC process(es) with Linux command "kill -9 <process>"."""

    __description__ = """Restart the running NXOS DC process(es) with Linux command "kill -9 <process>"
