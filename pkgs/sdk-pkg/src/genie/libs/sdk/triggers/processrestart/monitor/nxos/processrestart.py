'''
Implementation for Monitor Restart triggers
'''
...
class TriggerProcessCrashRestartMonitor(TriggerProcessRestart):
    """Restart the running Monitor process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core."""
    
    __description__ = """Restart the running Monitor process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core.
...
class TriggerProcessKillRestartMonitor(TriggerProcessRestart):
    """Restart the running Monitor process(es) with Linux command "kill -9 <process>"."""

    __description__ = """Restart the running Monitor process(es) with Linux command "kill -9 <process>"
