'''
Implementation for RIP Restart triggers
'''
...
class TriggerProcessCliRestartRip(TriggerProcessRestart):
    """Restart the running RIP process(es) with CLI command "restart rip <process>" """

    __description__ = """Restart the running RIP process(es) with CLI command "restart rip <process>"
...
class TriggerProcessCrashRestartRip(TriggerProcessRestart):
    """Restart the running RIP process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core."""
    
    __description__ = """Restart the running RIP process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core.
...
class TriggerProcessKillRestartRip(TriggerProcessRestart):
    """Restart the running RIP process(es) with Linux command "kill -9 <process>" """

    __description__ = """Restart the running RIP process(es) with Linux command "kill -9 <process>"
