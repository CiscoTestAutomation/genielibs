...
class BgpOutput(object):
    ...
    AdvertisedIpv6Output = '''\
        ...
        47.1.1.0/24        30.1.5.1        1.1.2.2         100 300 33299 51178 47751 {27016}e
        47.1.4.0/24        30.1.5.1        1.1.2.2         100 300 33299 51178 47751 {27016}e
        47.1.5.0/24        30.1.5.1        1.1.2.2         100 300 33299 51178 47751 {27016}e
        47.2.2.0/24        30.1.5.1        1.1.2.2         100 400 33299 51178 47751 {27016}e
    ...
    BgpInfo = {'instance': {'default': {'bgp_id': 100,
                          ...
                          'vrf': {'VRF1': {'address_family': {'ipv4 unicast': {'client_to_client_reflection': False,
                                  ...
                                  'default': {'address_family': {'ipv4 unicast': {'client_to_client_reflection': True,
                                              ...
                                              'fast_external_fallover': True,
                                              'log_neighbor_changes': True,
                                              'neighbor': {'2.2.2.2': {'address_family': {'vpnv4 unicast': {'bgp_table_version': 43,
