'''
Implementation for Aclmgr Restart triggers
'''
# Genie Libs
...
class TriggerProcessCrashRestartAclmgr(TriggerProcessRestart):
    """Restart the running Aclmgr process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core."""
    
    __description__ = """Restart the running Aclmgr process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core.
...
class TriggerProcessKillRestartAclmgr(TriggerProcessRestart):
    """Restart the running Aclmgr process(es) with Linux command "kill -9 <process>"."""

    __description__ = """Restart the running Aclmgr process(es) with Linux command "kill -9 <process>"
