'''
Implementation for EIGRP Restart triggers
'''
...
class TriggerProcessCliRestartEigrp(TriggerProcessRestart):
    """Restart the running EIGRP process(es) with CLI command "restart eigrp <process>"."""
    
    __description__ = """Restart the running EIGRP process(es) with CLI command "restart eigrp <process>"
...
class TriggerProcessCrashRestartEigrp(TriggerProcessRestart):
    """Restart the running EIGRP process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core."""

    __description__ = """Restart the running EIGRP process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core.
...
class TriggerProcessKillRestartEigrp(TriggerProcessRestart):
    """Restart the running EIGRP process(es) with Linux command "kill -9 <process>"."""

    __description__ = """Restart the running EIGRP process(es) with Linux command "kill -9 <process>"
