'''
Implementation for ISIS Restart triggers
'''
...
class TriggerProcessCliRestartIsis(TriggerProcessRestart):
    """Restart the running ISIS process(es) with CLI command "restart isis <process>"."""
    
    __description__ = """Restart the running ISIS process(es) with CLI command "restart isis <process>"
...
class TriggerProcessCrashRestartIsis(TriggerProcessRestart):
    """Restart the running ISIS process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core."""

    __description__ = """Restart the running ISIS process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core.
...
class TriggerProcessKillRestartIsis(TriggerProcessRestart):
    """Restart the running ISIS process(es) with Linux command "kill -9 <process>"."""

    __description__ = """Restart the running ISIS process(es) with Linux command "kill -9 <process>"
