'''
Implementation for IGMP Restart triggers
'''
...
class TriggerProcessCliRestartIgmp(TriggerProcessRestart):
    """Restart the running IGMP process(es) with CLI command "restart igmp <process>"."""
    
    __description__ = """Restart the running IGMP process(es) with CLI command "restart igmp <process>"
...
class TriggerProcessCrashRestartIgmp(TriggerProcessRestart):
    """Restart the running IGMP process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core."""

    __description__ = """Restart the running IGMP process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core.
...
class TriggerProcessKillRestartIgmp(TriggerProcessRestart):
    """Restart the running IGMP process(es) with Linux command "kill -9 <process>"."""

    __description__ = """Restart the running IGMP process(es) with Linux command "kill -9 <process>"
