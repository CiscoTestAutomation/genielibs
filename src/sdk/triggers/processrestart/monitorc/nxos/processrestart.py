'''
Implementation for Monitorc Restart triggers
'''
...
class TriggerProcessCrashRestartMonitorc(TriggerProcessRestart):
    """Restart the running Monitorc process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core."""
    
    __description__ = """Restart the running Monitorc process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core.
...
class TriggerProcessKillRestartMonitorc(TriggerProcessRestart):
    """Restart the running Monitorc process(es) with Linux command "kill -9 <process>"."""

    __description__ = """Restart the running Monitorc process(es) with Linux command "kill -9 <process>"
