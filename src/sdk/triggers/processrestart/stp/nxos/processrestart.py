'''
Implementation for Stp Restart triggers
'''
...
class TriggerProcessCrashRestartStp(TriggerProcessRestart):
    """Restart the running Stp process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core."""
    
    __description__ = """Restart the running Stp process(es) with linux command "kill -6 <process>",
    expecting process crashes and generates a core.
...
class TriggerProcessKillRestartStp(TriggerProcessRestart):
    """Restart the running Stp process(es) with Linux command "kill -9 <process>" """

    __description__ = """Restart the running Stp process(es) with Linux command "kill -9 <process>"
