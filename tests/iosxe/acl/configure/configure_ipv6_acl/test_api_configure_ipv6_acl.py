...
class TestConfigureIpv6Acl(unittest.TestCase):
    ...
    def test_configure_ipv6_acl(self):
        result = configure_ipv6_acl(device=self.device, acl_name='racl-1', service_type='tcp', src_nw='2013:1::20', dst_nw='2013:1::10', rule='permit', host_option=True, prefix='', dst_port='179', log_option='log', sequence_num='200')
