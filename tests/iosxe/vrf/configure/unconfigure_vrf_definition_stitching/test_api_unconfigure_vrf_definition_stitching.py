...
from genie.libs.sdk.apis.iosxe.vrf.configure import unconfigure_vrf_definition_stitching
...
class TestUnconfigureVrfDefinitionStitching(unittest.TestCase):
    ...
    def test_unconfigure_vrf_definition_stitching(self):
        result = unconfigure_vrf_definition_stitching(self.device, 'red', 'ipv6', '1:1')
